...
#define TEMBOO_ACCOUNT "jonasz"  // Your Temboo account name 
#define TEMBOO_APP_KEY_NAME "alarmduino"  // Your Temboo app key name
#define TEMBOO_APP_KEY "o8JfTxDOMSkPVLtfbg26W9A6fPsIqwnS"  // Your Temboo app key
